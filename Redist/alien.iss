...
Name: {group}\Instrucciones - Cómo Jugar; Filename: {app}\instrucciones.pdf; Comment: Cómo Jugar una Aventura; IconFilename: {app}\Leame.ico; IconIndex: 0
