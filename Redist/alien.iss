...
DefaultDirName={pf}\A·L·I·E·N - La aventura (Edición Especial)
DefaultGroupName=A·L·I·E·N - La aventura (Edición Especial)
...
Source: garglk.ini.normal; DestDir: {app}
Source: garglk.ini.hidpi; DestDir: {app}
Source: normal.bat; DestDir: {app}
Source: hidpi.bat; DestDir: {app}
...
[Icons]
Name: {group}\Jugar a A·L·I·E·N - La aventura (Edición Especial) en resolución normal; Filename: {cmd}; IconFilename: {app}\alien.ico; Parameters: "/c normal.bat"; WorkingDir: {app}\; IconIndex: 0; Comment: Juega a A·L·I·E·N - La aventura (Edición Especial)
Name: {group}\Jugar a A·L·I·E·N - La aventura (Edición Especial) en resolución HiDPI; Filename: {cmd}; IconFilename: {app}\alien.ico; Parameters: "/c hidpi.bat"; WorkingDir: {app}\; IconIndex: 0; Comment: Juega a A·L·I·E·N - La aventura (Edición Especial)
...
Name: {userdesktop}\Jugar a A·L·I·E·N - La aventura (Edición Especial) en resolución normal; Filename: {cmd}; IconFilename: {app}\alien.ico; Parameters: "/c normal.bat"; WorkingDir: {app}\; IconIndex: 0; Comment: Juega a A·L·I·E·N - La aventura (Edición Especial); Tasks: escritorio
Name: {userdesktop}\Jugar a A·L·I·E·N - La aventura (Edición Especial) en resolución HiDPI; Filename: {cmd}; IconFilename: {app}\alien.ico; Parameters: "/c hidpi.bat"; WorkingDir: {app}\; IconIndex: 0; Comment: Juega a A·L·I·E·N - La aventura (Edición Especial); Tasks: escritorio
