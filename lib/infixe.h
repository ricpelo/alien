      ...
      switch (w) {
        ...
        default: wn--;
                 if (InfixRValueTerm() == 1) {
                   InfixRV_rvals-->n = parsed_number; ! parsed number is a global variable
...
[ InfixExamineP brief x a b w flag lines;
  switch (infix_term_type) {
    ...
    INFIXTT_ATTRIBUTE:
      ...
      print "; Attribute ", (InfixPrintAttribute) noun, " (numbered ", noun, ")^";
    ...
    INFIXTT_ACTION:
      ...
      print "; Action ", (InfixPrintAction) noun, " (numbered ", noun, ")^";
...
[ InfixInvSub i;
  ...
  style bold;
  print "^- ", (number) #highest_object_number - #lowest_object_number + 1, " objetos;^";
...
Verb meta ";watch" ";w" ";observa" ";o"
  ...
  * "objects"/"objetos"                       -> ChangesOn
  * "objects"/"objetos" "off"                 -> ChangesOff
